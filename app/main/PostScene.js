            ...
            <ScrollableTabView
                ...
                renderTabBar={() =>
                    <ConstractTabBar findBack={()=>{
                        this.props.toNextPage({name: 'FindPostListScene',
                            component: FindPostListScene,
                            params: {}})
                    }} tabName={["好工作", "高返费",'小时工','假期工']} callBack={()=>{
                        this.refs.postlistsceness.changeShow();
                    }}/>}
            >
                <PostListScene toNextPage={(content)=>{
                    this.props.toNextPage(content)
                }} ref='postlistsceness' tabLabel="ios-paper" name={'好工作'} />

                <PostListScene toNextPage={(content)=>{
                    this.props.toNextPage(content)
                }} tabLabel="ios-people" name={'高返费'}/>
